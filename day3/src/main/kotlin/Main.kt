...
fun task1(array: Array<String>) {
    ...
    for (i in 1 until array.size) {
        for (j in 0 until array[1].length) {
            if (array[i][j] != '.' && !array[i][j].isDigit()) {
                if (array[i][j] != '*') {
                    val numbersAround = findNumbers(array, i, j)
                    println("Numbers around (${i + 1}, ${j + 1}): $numbersAround")
                    numbersAround.forEach {
                        sum += it
                    }
                } else {
                    val numbersAround = findNumbers(array, i, j)
...
fun findNumbers(array: Array<String>, i: Int, j: Int): List<Int> {
    ...
    while (tempI <= i + 1) {
        var tempJ = j - 1
        while (tempJ <= j + 1) {
            if (tempI in array.indices && tempJ in array[tempI].indices && array[tempI][tempJ].isDigit()) {
                val number = parseNumber(array, tempI, tempJ)
                list += number.first
            }
            tempJ++
        }
...
fun parseNumber(array: Array<String>, i: Int, j: Int): Pair<Int, Int> {
    var tempJ = j
    while (tempJ > 0 && array[i][tempJ - 1].isDigit()) {
        tempJ--
    }

    var num = ""
    while (tempJ < array[i].length && array[i][tempJ].isDigit()) {
        num += array[i][tempJ]
        tempJ++
    }

    return num.toInt() to i
}
...
//const val puzzle = """.........................3.......................................94...............806....................596.........793...........186......
